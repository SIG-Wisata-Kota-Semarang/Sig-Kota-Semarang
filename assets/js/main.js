...
function toggleTheme() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Menambahkan event listener ke checkbox toggle
    const themeToggleCheckbox = document.getElementById('theme-toggle');
  ...
  // ID video YouTube (Gantilah dengan ID video YouTube Anda)
  const youtubeVideoID = 'rgjIY7FKBkQ'; 

  // Fungsi untuk menampilkan video overlay
  playButton.addEventListener('click', function() {
    videoOverlay.style.display = 'flex';
    videoPlayer.src = `https://www.youtube.com/embed/${youtubeVideoID}?rel=0&showinfo=0`; // Jangan autoplay
  });

  // Fungsi untuk menutup video overlay
  closeButton.addEventListener('click', function() {
    videoOverlay.style.display = 'none';
    videoPlayer.src = ''; // Hentikan video dengan mengosongkan src
  });
